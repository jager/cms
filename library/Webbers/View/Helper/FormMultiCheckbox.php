<?php
/** Description of FormMultiCheckboxWithDIv
 *
 * @author mjagusia
 */
class Webbers_View_Helper_FormMultiCheckbox extends Webbers_View_Helper_FormRadioWithDiv
{
    /**
     * Input type to use
     * @var string
    ...
    {
        return $this->formRadioWithDiv($name, $value, $attribs, $options, $listsep);
    }
}
?>
